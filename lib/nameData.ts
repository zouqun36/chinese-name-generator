...
export const PHONEME_MAP: Record<string, string[]> = {
  al: ["阿","艾"], an: ["安","晏"], ar: ["雅","阿"], be: ["贝","蓓"],
  br: ["博","布"], ca: ["嘉","卡"], ch: ["晨","澄"], cl: ["柯","克"],
  co: ["可","科"], da: ["达","大"], de: ["德","迪"], di: ["迪","蒂"],
  el: ["艾","伊"], em: ["恩","艾"], en: ["恩","安"], er: ["尔","艾"],
  ev: ["伊","艾"], fr: ["弗","福"], ga: ["嘉","佳"], ge: ["格","戈"],
  gr: ["格","葛"], ha: ["涵","哈"], he: ["赫","和"], hi: ["熙","希"],
  ho: ["浩","昊"], hu: ["胡","虎"], ja: ["嘉","佳"], je: ["杰","洁"],
  jo: ["乔","珏"], ju: ["菊","珏"], ka: ["嘉","卡"], ke: ["柯","可"],
  ki: ["琪","奇"], la: ["兰","拉"], le: ["乐","勒"], li: ["丽","莉"],
  lo: ["洛","罗"], lu: ["露","鲁"], ly: ["丽","莉"], ma: ["玛","马"],
  me: ["美","梅"], mi: ["敏","米"], mo: ["墨","默"], na: ["娜","纳"],
  ni: ["妮","倪"], no: ["诺","娜"], ol: ["奥","欧"], pa: ["佩","帕"],
  pe: ["培","佩"], ph: ["菲","飞"], ra: ["瑞","睿"], re: ["瑞","睿"],
  ri: ["瑞","睿"], ro: ["罗","洛"], ru: ["如","茹"], sa: ["莎","萨"],
  se: ["思","瑟"], sh: ["珊","善"], si: ["思","斯"], so: ["苏","索"],
  st: ["思","斯"], su: ["苏","素"], ta: ["泰","塔"], te: ["泰","特"],
  th: ["泰","思"], ti: ["蒂","缇"], to: ["陶","托"], tr: ["泰","特"],
  va: ["薇","瓦"], ve: ["维","薇"], vi: ["维","薇"], wa: ["华","瓦"],
  wi: ["威","维"], xa: ["霞","夏"], xi: ["熙","希"], ya: ["雅","亚"],
  ye: ["叶","耶"], yo: ["悠","优"], yu: ["玉","宇"], za: ["泽","扎"],
  ze: ["泽","则"], zh: ["珍","真"], zi: ["紫","子"], zo: ["卓","佐"],
  a:  ["阿","雅","安"], e: ["伊","依","宜"], i: ["伊","依","仪"],
  o:  ["欧","奥"],      u: ["宇","玉","悠"],
};
